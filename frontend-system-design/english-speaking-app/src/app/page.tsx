...
import {
  FeatureFlagMenu,
  useFlags,
} from "@/shared/components/ui/FeatureFlagMenu";
...
const features = [
  {
    ...
    description:
      "Kết nối video HD mượt mà, hỗ trợ nhóm lên đến 12 người với âm thanh rõ ràng.",
  },
  {
    ...
    description:
      "Luyện tập với AI 24/7, nhận phản hồi tức thì về phát âm và ngữ pháp.",
  },
  {
    ...
    description:
      "Tìm phòng phù hợp từ A1 đến C2, học cùng người có trình độ tương đương.",
  },
  {
    ...
    description:
      "Kiếm điểm XP mỗi khi luyện tập, mở khóa huy hiệu và leo bảng xếp hạng.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Cộng đồng được kiểm duyệt, môi trường học tập tích cực và hỗ trợ.",
  },
];
...
const testimonials = [
  {
    ...
    level: "B2",
    quote:
      "Sau 3 tháng luyện tập mỗi ngày 30 phút, điểm IELTS Speaking của mình tăng từ 5.5 lên 7.0!",
  },
  {
    name: "Park Ji-young",
    ...
    level: "B1",
    quote:
      "Tuyệt vời! Mình đã kết bạn với nhiều người từ khắp thế giới và tiếng Anh cải thiện rõ rệt.",
  },
  {
    name: "Tanaka Yuki",
    ...
    level: "A2",
    quote:
      "Ứng dụng thân thiện, dễ sử dụng. AI tutor giúp mình luyện tập khi không có partner.",
  },
];
        ...
        >
          ...
          >
            ...
            <Text
              ...
              mx="auto"
            >
              Tham gia cùng hàng nghìn người học và bắt đầu nói tiếng Anh ngay
              hôm nay
            </Text>
          ...
          >
            ...
            <Box maw={300}>
              ...
              <Text size="sm" c="dimmed" lh={1.6}>
                Nền tảng luyện nói tiếng Anh trực tuyến hàng đầu, kết nối người
            ...
            <Group gap={60} align="flex-start">
              ...
              <Box>
                ...
                {["Trung tâm trợ giúp", "Liên hệ", "Điều khoản", "Bảo mật"].map(
                  (item) => (
                    <Text
                      key={item}
                      size="sm"
