...
export function usePlan(): PlanInfo {
    ...
    const tokenRenewalDate = useAppSelector((state) => state.user.tokenRenewalDate);
    const userPlan = useAppSelector((state) => state.user.plan);
    const auth0Email = useAppSelector((state) => state.user.email);
    const apiPlanTokenRenewalDate = useAppSelector((state) => state.user.apiPlanTokenRenewalDate);
